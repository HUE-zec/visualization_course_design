...
import { getComputerTopListApi } from '../../api'

const ComputerSalesChart = ({ data }) => {
  useEffect(() => {
    const chartDom = document.getElementById('computerSalesChart');
  ...
  return <div id="computerSalesChart" style={{ width: '100%', height: 600 }} />;
};

export default function Computer () {
  const [data, setData] = useState([])
  useEffect(() => {
    getComputerTopListApi().then(res => {
