...
import { getNvzhuangTopListApi, getShipinTopListApi } from '../../api';

const NvzhuangSalesChart = ({ data }) => {
  useEffect(() => {
    const chartDom = document.getElementById('foodSalesChart');
  ...
  return <div id="foodSalesChart" style={{ width: '100%', height: 600 }} />;
};

export default function Nvzhuang () {
  const [data, setData] = useState([])
  useEffect(() => {
    getShipinTopListApi().then(res => {
